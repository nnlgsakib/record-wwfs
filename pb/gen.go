...
//
//go:generate mkdir -p github.com/nnlgsakib/record-wwfs/pb
//go:generate ln -f record.proto github.com/nnlgsakib/record-wwfs/pb/
//go:generate protoc --go_out=. github.com/nnlgsakib/record-wwfs/pb/record.proto
//go:generate mv -f github.com/nnlgsakib/record-wwfs/pb/record.pb.go .
